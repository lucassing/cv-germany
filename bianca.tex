...
{Germany · Remote}
{
• Served as Technical Team Lead for Android, driving architecture decisions, code quality, and delivery strategy.\\
• Led planning and execution of key Android initiatives with the Software Architect and Product Management.\\
• Owned the release of the new Android app to Google Play Store, handling signing, configuration, and publishing compliance.\\
• Coordinated cross-functional work with Backend and QA to ensure smooth delivery and resolve dependencies.\\
• Improved release management processes, including versioning strategy and internal QA build workflow.\\
}
{
